...
{ id:"azazil", name:"Azazil", altName:"nome de Iblis (Satanás) antes da queda", img:"islam-azazil",
  role:"Segundo a tradição islâmica, Azazil ocupava uma posição de destaque entre os que viviam junto aos anjos, distinguindo-se pelo vasto conhecimento e pela devoção. Após a criação de Adão, quando Deus ordenou que todos se prostrassem diante do novo ser, recusou-se por soberba — por julgar-se superior, tendo sido criado do fogo —, o que resultou em sua condenação e expulsão do paraíso, tornando-se Iblis, o líder dos demônios (shayatin).",
  meaning:'Não é, a rigor, um anjo: o Alcorão (18:50) o classifica como um jinn, e a doutrina majoritária sustenta que anjos são infalíveis e não podem pecar. Por isso os exegetas divergem quanto à sua natureza original — para Ibn Abbas e outros, era um anjo de posição elevada (querubim); para Hasan al-Basri e a maioria dos teólogos sunitas, era um jinn extremamente devoto e "obediente" que vivia entre os anjos e adorava a Deus ao lado deles, sem jamais ser um deles. É essa fronteira ambígua — quase angelical em devoção, mas de origem ígnea e dotado de livre-arbítrio — que faz de sua história a explicação islâmica para a origem dos demônios.',
  refs:[
    {cite:"Alcorão 18:50", quote:'E quando dissemos aos anjos: "Prosternai-vos diante de Adão", todos se prosternaram, exceto Iblis. Ele era um dos jinns e desobedeceu à ordem de seu Senhor.'},
    {cite:"Alcorão 2:34", quote:'E quando dissemos aos anjos: "Prosternai-vos diante de Adão", todos se prosternaram, exceto Iblis, que se recusou e ensoberbeceu-se, tornando-se um dos incrédulos.'},
    {cite:"Alcorão 38:76", quote:'Disse: "Sou melhor do que ele: criaste-me do fogo e a ele criaste do barro."'},
    {cite:"Alcorão 15:26-27", quote:"Deus criou o homem de barro seco, e antes já havia criado os jinns do fogo puríssimo, sem fumaça."}
  ]}
];
...
const modalBadgeBtn = document.getElementById("modalBadgeBtn");
...
function openModal(id){
  ...
  if(!a) return;
  currentAngel = a;
  modalImage.src = "img/"+a.img+".webp";
  modalImage.alt = a.name;
...
document.addEventListener("keydown", function(e){ if(e.key==="Escape" && backdrop.classList.contains("open") && !lightbox.classList.contains("open")) closeModal(); });
...
function openLightbox(){
  ...
  lightboxImage.src = "img/"+currentAngel.img+".webp";
  lightboxImage.alt = currentAngel.name;
  lightboxCaption.textContent = currentAngel.name;
  lightbox.classList.add("open");
}
function closeLightbox(){
  lightbox.classList.remove("open");
}
modalBadgeBtn.addEventListener("click", openLightbox);
