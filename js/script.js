...
{ num:5, name:"Virtudes", img:"virtudes",
  ...
  apoc:{
    ...
    angels:[
      {name:"Gabriel",title:"também associado ao coro das virtudes. Ver Nota Especial.",source:"Apócrifo — 1 Enoque",refs:[{cite:"1 Enoque 40:9",quote:"Gabriel como um dos quatro anjos principais diante do Senhor."}]},
...
{ num:7, name:"Principados", img:"principados",
  ...
  canon:{
    ...
    angels:[{name:"Miguel",title:"príncipe de Israel. Ver Nota Especial.",source:"Cânon — Daniel",refs:[{cite:"Daniel 10:13,21; 12:1",quote:"Naquele tempo se levantará Miguel, o grande príncipe que se levanta a favor dos filhos do teu povo."}]}],
    readings:[
  ...
  apoc:{
    ...
    angels:[
      {name:"Miguel",title:"príncipe de Israel. Ver Nota Especial.",source:"Apócrifo — 1 Enoque",refs:[{cite:"1 Enoque 20:5",quote:"Miguel, um dos santos anjos, posto sobre a melhor parte da humanidade."}]},
